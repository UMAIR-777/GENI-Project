...
def run_step_tests_and_evaluate_coverage(
    production_file: str = "src/embedding_service.py",
    tests_dir: str = "BDD/tests_dir/test/test_embedding_service.py",
    report_file: str = "BDD/tests_dir/C_Reports/embedding_service_coverage_report.json"
) -> dict:
    """
