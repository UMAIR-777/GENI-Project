...
def run_step_tests_and_evaluate_coverage(
    production_file: str = "src/database_manager.py",
    tests_dir: str = "BDD/tests_dir/test/test_database_manager.py",
    report_file: str = "BDD/tests_dir/C_Reports/database_manager_coverage_report.json"
) -> dict:
    """
